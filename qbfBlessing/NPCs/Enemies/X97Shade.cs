...
{
    [AutoloadBossHead]
    class X97Shade : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("X97 Shade");
        ...
        {
            npc.aiStyle = 31; // Spazi AI for now.. might improve later or make my own, if I feel adventurous.
            npc.lifeMax = 666666; // Ha funny
            npc.damage = 300; // Ha funny (again)
            npc.defense = 600; // No more 'Ha, funny', this is an endgame boss btw
