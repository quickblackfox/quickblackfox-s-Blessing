...
{
    [AutoloadBossHead]
    class ServantofX97 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Servant Of X97");
        ...
        public override void SetDefaults()
        {
            ...
            npc.damage = 550; // Ha funny (again)
            npc.defense = 450; // No more 'Ha, funny', this is an endgame boss btw
